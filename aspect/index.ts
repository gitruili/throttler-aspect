...
class Aspect implements IPreContractCallJP {
    ...
    preContractCall(input: PreContractCallInput): void {
        ...
        const contractAddress = unit8ArrayToHex(input.call!.to);
        const from = unit8ArrayToHex(input.call!.from);
        ...
        const blockTime = ProtoBuf.decode<UnitData>(blockTimeBytes, UnitData.decode).data;
